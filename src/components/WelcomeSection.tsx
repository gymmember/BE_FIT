...
export function WelcomeSection() {
  ...
  const fullText = "Welcome to Be Fit • Jhargram's most trusted destination for real transformation! • Since our launch, Be Fit has become the go-to place for those serious about fitness. • Whether you're just starting out or a seasoned lifter, our certified trainers, cutting-edge equipment, and motivating environment ensure you get the results you're looking for. • Here, fitness isn't a routine — it's a lifestyle fueled by passion. • ";
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-16 sm:py-24 relative z-10" id="welcome-section">
      ...
      <div className="w-full overflow-hidden bg-zinc-900/30 border-y border-zinc-800/50 py-3 mb-10 relative">
        ...
        >
          <span className="text-amber-500 font-mono text-xs font-black uppercase tracking-[0.3em] px-4">
            {fullText} {fullText}
          </span>
        </motion.div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12">
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="space-y-4">
            <p className="text-zinc-300 text-lg font-medium border-l-4 border-amber-500 pl-4 py-1 bg-amber-500/5">
